...
public class PersonControllerTest {
    ...
    @Test
    public void getPerson_should_throwNotFoundExceptionWhenIDDoesNotExist() throws Exception {

        when(this.personService.getById(PERSON_ID)).thenThrow(new NotFoundException("Person not found"));
    ...
    @Test
    public void addAddress_should_throwConflictExceptionWhenPersonDoesNotExist() throws Exception {
        ...
        when(this.personService.addAddress(eq(PERSON_ID), any()))
                .thenThrow(new ConflictException("Person not found"));
    ...
    @Test
    public void addAddress_should_badRequestWhenRequestBodyIsEmpty() throws Exception {
        this.mvc.perform(
                put("/person/" + PERSON_ID)
                        .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
        ).andExpect(status().isBadRequest());
