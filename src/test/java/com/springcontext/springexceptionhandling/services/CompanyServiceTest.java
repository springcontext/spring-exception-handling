...
public class CompanyServiceTest {
    ...
    @Test
    public void getById_should_fetchExistingPerson() throws NotFoundException {
        Company company = new Company();
    ...
    public void getById_should_throwNotFoundExceptionWhenIdDoesNotExist() throws NotFoundException {
        Company company = this.companyService.getById(NOT_FOUND_ID);
    }
