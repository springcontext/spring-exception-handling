...
public class CompanyControllerTest {
    ...
    @Test
    public void getEmployees_should_throwNotFoundExceptionWhenCompanyDoesNotExist() throws Exception {

        when(this.companyService.getById(COMPANY_ID)).thenThrow(new NotFoundException("Company not found"));
    ...
    @Test
    public void addEmployee_should_throwNotFoundExceptionWhenCompanyDoesNotExist() throws Exception {

        when(this.companyService.addEmployee(COMPANY_ID, PERSON_ID))
                .thenThrow(new ConflictException("Employee not found"));
